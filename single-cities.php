...
<?php
                ...
                $content = ["NOTABLE FEATURES" => "known-for", "TRAVELER'S NOTES" => "travelers-notes", "ACTIVITIES" => ["Popular Activities" => "activities", "Underrated Destinations" => "underrated"], "NEIGHBORHOODS" => "neighborhoods", "HOW TO GET HERE" => "arrival"];
