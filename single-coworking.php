...
?>
                ...
                <section id="basic-info-section" class="content section">
                    <div id="info-panel">
                        <h3>QUICK FACTS</h3>
<?php
                        $country_keys = array("COWORKING SPACE" => "name", "CITY" => ["location-post", ["get-permalink", "location-en"]], "COST" => ["daily-cost", "monthly-cost", "cost-explanation"], "FRIENDLINESS" => "friendliness", "LOCATION" => "location", "LAST UPDATED" => "active-date");
