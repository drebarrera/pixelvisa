    ...
    <div class="content">
        ...
        <div id="panel-outer">
            ...
            <div class="filter-button" id="search" style="--color: var(--green);" data-entrytype="country" onclick="search(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10S2 17.514 2 12 6.486 2 12 2zm0-2C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm1.608 9.476L12 4l-1.611 5.477a3.019 3.019 0 0 0-1.019 1.107L4 12l5.37 1.416c.243.449.589.833 1.019 1.107L12 20l1.618-5.479a3.004 3.004 0 0 0 1.014-1.109L20 12l-5.368-1.413a2.996 2.996 0 0 0-1.024-1.111zM12 13.5a1.5 1.5 0 1 1 .001-3.001A1.5 1.5 0 0 1 12 13.5zm5.25 3.75-2.573-1.639c.356-.264.67-.579.935-.934l1.638 2.573zm-2.641-8.911 2.64-1.588-1.588 2.639a4.486 4.486 0 0 0-1.052-1.051zm-5.215 7.325L6.75 17.25l1.589-2.641c.29.408.646.764 1.055 1.055zm-1.005-6.34L6.751 6.751l2.573 1.638a4.456 4.456 0 0 0-.935.935z"/></svg>Filter By Country: <input type="text"></input></div>
                <div class="filter-button" id="search" style="--color: var(--orange);" data-entrytype="location" onclick="search(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M200-80v-800h80v80h560l-80 200 80 200H280v320h-80Zm80-640v240-240Zm220 200q33 0 56.5-23.5T580-600q0-33-23.5-56.5T500-680q-33 0-56.5 23.5T420-600q0 33 23.5 56.5T500-520Zm-220 40h442l-48-120 48-120H280v240Z"/></svg>Filter By City: <input type="text"></input></div>
