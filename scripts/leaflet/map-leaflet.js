...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for (let datum in panel_data) {
        ...
        if (countries.hasOwnProperty(panel_data[datum].country.toLowerCase)) countries[panel_data[datum].country.toLowerCase][1].append(location_entry.dataset.markerid);
